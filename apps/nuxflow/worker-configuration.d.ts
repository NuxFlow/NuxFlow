/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7915ca807eb9c5e0cdb28876674a8a90)
// Runtime types generated with workerd@1.20260625.1 2026-04-01 nodejs_compat
interface __BaseEnv_Env {
	...
	NUXT_CLOUDFLARE_IMAGES_TOKEN: string;
	NUXT_CLOUDFLARE_ACCOUNT_ID: string;
	NUXT_CLOUDFLARE_IMAGES_DELIVERY_URL: string;
	NUXT_EMAIL_PROVIDER: string;
	NUXT_RESEND_API_KEY: string;
	NUXT_BREVO_API_KEY: string;
	NUXT_ZEPTO_API_KEY: string;
	NUXT_STRIPE_SECRET_KEY: string;
	NUXT_STRIPE_WEBHOOK_SECRET: string;
	NUXT_LS_API_KEY: string;
	NUXT_LS_STORE_ID: string;
	NUXT_LS_WEBHOOK_SECRET: string;
	NUXT_PADDLE_API_KEY: string;
	NUXT_PADDLE_VENDOR_ID: string;
	NUXT_PADDLE_WEBHOOK_PUBLIC_KEY: string;
	NUXT_PUBLIC_SITE_URL: string;
	NUXT_PUBLIC_CLOUDFLARE_IMAGES_DELIVERY_URL: string;
	NUXT_PUBLIC_TURNSTILE_SITE_KEY: string;
	TEST_ADMIN_EMAIL: string;
	TEST_ADMIN_PASSWORD: string;
	ARGON2: Fetcher /* nuxflow-argon2 */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUXT_BETTER_AUTH_SECRET" | "NUXT_GOOGLE_CLIENT_ID" | "NUXT_GOOGLE_CLIENT_SECRET" | "NUXT_GITHUB_CLIENT_ID" | "NUXT_GITHUB_CLIENT_SECRET" | "NUXT_CLOUDFLARE_IMAGES_TOKEN" | "NUXT_CLOUDFLARE_ACCOUNT_ID" | "NUXT_CLOUDFLARE_IMAGES_DELIVERY_URL" | "NUXT_EMAIL_PROVIDER" | "NUXT_RESEND_API_KEY" | "NUXT_BREVO_API_KEY" | "NUXT_ZEPTO_API_KEY" | "NUXT_STRIPE_SECRET_KEY" | "NUXT_STRIPE_WEBHOOK_SECRET" | "NUXT_LS_API_KEY" | "NUXT_LS_STORE_ID" | "NUXT_LS_WEBHOOK_SECRET" | "NUXT_PADDLE_API_KEY" | "NUXT_PADDLE_VENDOR_ID" | "NUXT_PADDLE_WEBHOOK_PUBLIC_KEY" | "NUXT_PUBLIC_SITE_URL" | "NUXT_PUBLIC_CLOUDFLARE_IMAGES_DELIVERY_URL" | "NUXT_PUBLIC_TURNSTILE_SITE_KEY" | "TEST_ADMIN_EMAIL" | "TEST_ADMIN_PASSWORD">> {}
}
