...
- 8071c7d: feat: email inbox, post-by-email, and security/system alerts built on Cloudflare Email Routing and Email Sending
...
- Updated dependencies [8071c7d]
  - @nuxflow/db@2.0.0-beta.6

## 2.0.0-beta.19

### Patch Changes

- efedd54: fix: web push delivery, events visibility, plugin blocks, and smaller bugs found in a full test audit
...
- 5650e28: fix: LemonSqueezy/Paddle billing-portal parity, touch-safe header dropdown nav, and expanded route test coverage
