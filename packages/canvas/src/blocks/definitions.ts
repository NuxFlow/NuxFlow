...
export const CANVAS_BLOCKS: CanvasBlockDefinition[] = [
  ...
  // ── Footer ────────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      {
        key: 'col1Links', label: 'Column 1 Links', type: 'list',
        fields: [
      ...
      {
        key: 'col2Links', label: 'Column 2 Links', type: 'list',
        fields: [
          { key: 'label', label: 'Label', type: 'text' },
          { key: 'url', label: 'URL', type: 'url' },
        ],
  ...
  // ── Accordion / FAQ ────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      {
        key: 'itemsJson', label: 'Items', type: 'list',
        fields: [
  ...
  // ── Carousel ──────────────────────────────────────────────────────────────
  {
    id: 'canvas-carousel',
    name: 'Carousel',
    description: 'Auto-playing image slider with arrows and dot navigation — great for hero banners and showcases',
    ...
    fields: [
      ...
      { key: 'autoplay', label: 'Autoplay', type: 'toggle' },
      { key: 'interval', label: 'Autoplay interval (ms)', type: 'number', min: 1000, max: 15000, step: 500, condition: p => Boolean(p.autoplay) },
      { key: 'loop', label: 'Loop back to start', type: 'toggle' },
      { key: 'arrows', label: 'Show prev/next arrows', type: 'toggle' },
      { key: 'dots', label: 'Show dot navigation', type: 'toggle' },
      { key: 'rounded', label: 'Rounded corners', type: 'toggle' },
      { key: 'padding', label: 'Padding', type: 'spacing' },
    ],
    defaultProps: {
  ...
  // ── Calendar ──────────────────────────────────────────────────────────────
  {
    ...
    description: 'Displays a list or month-grid calendar of upcoming site events',
    ...
    fields: [
      ...
      { key: 'description', label: 'Description', type: 'textarea', placeholder: 'Join us at our upcoming events…' },
      {
        key: 'displayMode',
        label: 'Display Mode',
        type: 'select',
        options: [
          ...
          { label: 'Calendar Grid', value: 'month' },
        ],
      },
      { key: 'limit', label: 'Max events', type: 'number', min: 1, max: 50, step: 1 },
      { key: 'bgColor', label: 'Background colour', type: 'color' },
      { key: 'textColor', label: 'Text colour', type: 'color' },
      { key: 'padding', label: 'Padding', type: 'spacing' },
    ],
